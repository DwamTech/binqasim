  ...
  return (
    <section className={styles.frameSection}>
      <div className={styles.frameInner}>
        <h2 className={styles.title}>{title || "جمعية الآل والأصحاب"}</h2>
        {(paragraphs && paragraphs.length
          ? paragraphs
          : [
              "لَأنّ الدنيا وما فيها لا تَسوى عند الله جناح بعوضة، تم بفضل الله وتوفيقه تدشين جمعية الآل والأصحاب - بمكة المكرمة.",
              "جمعية الآل والأصحاب مخصص لرعاية طلاب العلم ومساندتهم في سبيل تحصيلهم للعلم والقيام بواجب الدعوة إلى الله تعالى على منهج أهل السنة والجماعة.",
