...
export default function IndividualRequestsPage() {
    ...
    return (
        <div className="space-y-6">
            ...
            <div id="filters" className="rounded-xl border border-gray-200 shadow-sm p-4 bg-gradient-to-r from-primary/10 to-secondary/10">
