            ...
            <div className="bg-white rounded-2xl p-8 max-w-2xl w-full mx-4 shadow-2xl animate-scaleIn max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-gray-800">تفاصيل الاقتراح</h2>
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <div className="p-4 rounded-xl bg-gray-50 text-gray-700 whitespace-pre-wrap">
                            {item.message}
                        </div>
                    </div>
                    ...
                    {item.attachment_path && (
                        <div>
                            ...
                            <a
                                ...
                                className="flex items-center gap-3 p-4 rounded-xl bg-primary/5 border-2 border-dashed border-primary/20 hover:border-primary/50 transition-colors"
                            >
                                <FiDownload className="text-primary" />
                                <span className="text-primary font-medium">تحميل المرفق</span>
                            </a>
                        </div>
                    )}
                </div>
...
export default function SuggestionsPage() {
    ...
    const fetchData = useCallback(async (page: number) => {
        setLoading(true);
        try {
            const result = await FeedbackService.getSuggestions(page);
            setData(result);
        } catch (error) {
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            ...
            showToast("تم حذف الاقتراح بنجاح", "success");
            fetchData(currentPage);
        } catch (error: any) {
            showToast(error.message || "فشل في حذف الاقتراح", "error");
        } finally {
            setDeletingId(null);
        }
    };
        ...
        <div className="space-y-8 pb-8">
                ...
                <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                    <div>
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm shadow-sm mb-4">
                            ...
                            <span className="text-sm font-bold text-gray-700">صندوق الاقتراحات</span>
                        </div>
                        <h1 className="text-3xl lg:text-4xl font-extrabold text-gray-900 mb-2">
                            اقتراحات المستفيدين
                        </h1>
                        <p className="text-gray-600 max-w-lg">
                            عرض وإدارة اقتراحات المستخدمين لتحسين الخدمات والمنصة.
                        </p>
                    </div>
            ...
            <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <StatCard
                    ...
                    icon={<FiMessageSquare className="text-xl text-secondary" />}
                    color="bg-secondary"
                />
                <StatCard
                ...
                <StatCard
                    ...
                    icon={<FiChevronLeft className="text-xl text-green-500" />}
                    color="bg-green-500"
                />
            </section>
                ...
                {loading ? (
                    <div className="flex items-center justify-center py-20">
                        <div className="relative">
                            ...
                            <FiZap className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-primary text-xl" />
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl p-12 shadow-lg text-center">
                        ...
                        <h3 className="text-lg font-semibold text-gray-600 mb-2">لا توجد اقتراحات</h3>
                        <p className="text-gray-400">لم يتم استلام أي اقتراحات حتى الآن</p>
                    </div>
                )}
            </section>
        </div>
