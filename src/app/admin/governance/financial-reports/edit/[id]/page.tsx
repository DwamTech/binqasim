            ...
            <section className="animated-hero relative overflow-hidden rounded-2xl p-6 md:p-8">
                ...
                <div className="relative z-10 flex items-center justify-between gap-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900">تعديل تقرير مالي</h1>
                            <p className="text-sm text-gray-700 mt-1">تحديث بيانات التقرير</p>
                        </div>
                    </div>
                    <button
                        onClick={() => router.push('/admin/governance/financial-reports')}
                        className="flex items-center gap-2 px-4 py-2 text-gray-700 bg-white/70 backdrop-blur-md rounded-lg hover:bg-white transition-colors shadow-sm"
                    >
