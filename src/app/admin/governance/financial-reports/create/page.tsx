            ...
            <section className="animated-hero relative overflow-hidden rounded-2xl p-6 md:p-8">
                ...
                <div className="relative z-10 flex items-center justify-between gap-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900">إضافة تقرير مالي جديد</h1>
                            <p className="text-sm text-gray-700 mt-1">أضف تقريراً مالياً جديداً</p>
                        </div>
                    </div>
                    <button
